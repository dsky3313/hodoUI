...
L["DUNGEON_SHORT_NAME_GMBT"] = "集市：宏图"
...
L["ENABLE_LFG_EXPORT_BUTTON"] = "在队伍查找器界面显示“导出队伍”按钮"
L["ENABLE_LFG_EXPORT_BUTTON_DESC"] = "在队伍查找器界面底部显示一个放大镜按钮，点击后可导出你当前的队伍成员及申请者名单，方便你复制并粘贴到 Raider.IO 网站上，快速查看每个人的资料。"
...
L["MINIMAP_SHORTCUT_BROKER_ENABLE"] = "启用插件集成菜单按钮"
L["MINIMAP_SHORTCUT_BROKER_ENABLE_DESC"] = "启用后将在插件集成菜单中显示图标，并支持所有兼容集成系统的其他插件中显示。"
...
L["RAID_BOSS_MFO_4"] = "熔炉编织者阿拉兹"
L["RAID_BOSS_MFO_5"] = "狩魂猎手"
...
L["RECENT_RUNS_WITH_YOU"] = "近期与一起完成的大秘境记录"
...
L["SHOW_WARBAND_SCORE"] = "在鼠标提示上显示战团大秘境分数和进度"
L["SHOW_WARBAND_SCORE_DESC"] = "在鼠标提示中显示玩家战团当前赛季的大秘境分数与团队副本进度。要启用战团进度显示，玩家需已在 Raider.IO 注册账号并完成战网账号同步。"
L["TANK"] = "坦克"
...
L["TIMED_RUNS_MINIMUM"] = "限时 %d+ 次大秘境"
L["TIMED_RUNS_RANGE"] = "限时 +%d-%d 大秘境"
...
L["WARBAND_BEST_SCORE_BEST_SEASON"] = "战团最高大秘境分数 (%s)"
L["WARBAND_SCORE"] = "战团大秘境分数"
