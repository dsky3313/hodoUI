...
L["BINDING_NAME_RAIDERIO_REPLAYUI_TOGGLE"] = "Вкл./выкл. повтор"
L["CANCEL"] = "Отменить"
...
L["CONFIG_WHERE_TO_SHOW_TOOLTIPS"] = "Где показывать прогресс М+ подземелий и рейда"
L["CONFIRM"] = "Подтвердить"
L["COPY_RAIDERIO_PROFILE_URL"] = "Копировать ссылку Raider.IO"
L["COPY_RAIDERIO_RECRUITMENT_URL"] = "Копировать ссылку рекрутинга"
L["COPY_RAIDERIO_URL"] = "Копировать ссылку Raider.IO"
L["CURRENT_MAINS_SCORE"] = "Текущий рейтинг М+ основного персонажа"
...
L["DISABLE_RWF_MODE_BUTTON_TOOLTIP"] = "Нажмите, чтобы отключить режим 'Гонка за первых в мире'. Это приведет к перезагрузке интерфейса."
L["DISABLE_RWF_MODE_RELOAD"] = "Вы отключаете режим 'Гонка за первых в мире'. Нажатие кнопки 'Подтвердить' перезагрузит Ваш интерфейс."
L["DPS"] = "Боец"
...
L["GUILD_BEST_TITLE"] = "Записи Raider.IO"
...
L["MINIMAP_SHORTCUT_HELP_SETTINGS"] = "Параметры"
...
L["MYTHIC_PLUS_SCORES"] = "Подсказки для рейтинга М+"
...
L["PROFILE_TOOLTIP_ANCHOR_TOOLTIP"] = "Заблокировать рамку профиля Raider.IO или включить автоматическое позиционирование, чтобы скрыть эту привязку."
...
L["RECENT_RUNS_WITH_YOU"] = "Недавние прохождения с Вами"
...
L["RELOAD_RWF_MODE_BUTTON_TOOLTIP"] = "Нажмите, чтобы сохранить журнал в файл хранилища. Это приведет к перезагрузке интерфейса."
L["REPLAY_AUTO_SELECTION"] = "Предпочтительный тип повтора"
L["REPLAY_AUTO_SELECTION_DESC"] = "Выберите тип повтора, который должен выбираться автоматически."
...
L["REPLAY_SETTINGS_TOOLTIP"] = "Параметры"
...
L["RWF_TITLE"] = "|cffFFFFFFRaider.IO|r Гонка за первых в мире"
...
L["SHOW_CHESTS_AS_MEDALS"] = "Показать значки медалей М+"
...
L["SHOW_IN_FRIENDS"] = "Показывать в подсказке списка друзей"
L["SHOW_IN_FRIENDS_DESC"] = "Показывает прогресс, наводя курсор на друзей."
L["SHOW_IN_LFD"] = "Показывать в подсказках поиска подземелий"
L["SHOW_IN_LFD_CLASSIC"] = "Показывать во всплывающих подсказках поиска групп"
L["SHOW_IN_LFD_DESC"] = "Показывать прогресс при наведении курсора на группу или кандидатов."
...
L["SHOW_IN_WHO_UI_DESC"] = "Показывать прогресс при наведении курсора мыши во вкладке \"Кто\"."
...
L["SHOW_LEADER_PROFILE"] = "Разрешить модификатор подсказки профиля Raider.IO"
...
L["SHOW_ON_GUILD_ROSTER_DESC"] = "Показывать прогресс при наведении курсора на членов гильдии и сообщества."
L["SHOW_ON_PLAYER_UNITS"] = "Показывать подсказки при наведении на игроков"
L["SHOW_ON_PLAYER_UNITS_DESC"] = "Показывать прогресс при наведении курсора на игрока."
...
L["SHOW_RAIDERIO_BESTRUN_FIRST"] = "(Экспериментально) Приоритет отображения лучшего прохождения"
...
L["SHOW_RAIDERIO_PROFILE_DESC"] = "Показывать всплывающую подсказку профиля Raider.IO"
L["SHOW_RAIDERIO_PROFILE_OPTION"] = "Показывать профиль Raider.IO"
L["SHOW_ROLE_ICONS"] = "Показывать иконку роли в подсказке"
L["SHOW_ROLE_ICONS_DESC"] = "Если включено, то лучшая роль игрока в М+ будет отображаться в его подсказке."
L["SHOW_SCORE_IN_COMBAT"] = "Показывать подсказку Raider.IO в бою"
...
L["UNLOCKING_PROFILE_FRAME"] = "Raider.IO: разблокировка фрейма профиля М+."
...
L["WARBAND_BEST_SCORE_BEST_SEASON"] = "Лучший результат М+ отряда (%s)"
L["WARBAND_SCORE"] = "Результат отряда М+"
L["WARNING_DEBUG_MODE_ENABLE"] = "|cffFFFFFF%s|r Режим отладки включен. Вы можете отключить его, введя команду |cffFFFFFF/raiderio debug|r."
...
L["WIPE_RWF_MODE_BUTTON_TOOLTIP"] = "Нажмите, чтобы стереть журнал из файла хранилища. Это приведет к перезагрузке интерфейса."
